...
- Automatizar a criação de produtos em R

- Criar documentos reprodutíveis

- Criar diversos tipos de produtos 

```{r, echo=FALSE, out.width="50%", fig.align='center', fig.cap="Ilustração por <a href='https://github.com/allisonhorst/stats-illustrations'> Allison Horst</a>."}
