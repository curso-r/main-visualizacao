---
title: "Extra: observações sobre gráficos com ggplot2"
...
A linha `mutate(especie = fct_reorder(especie, n))` transforma a coluna `especie` fazendo com que exista uma ordem relativa entre as categorias de acordo a coluna `n`, que representa as contagens.
