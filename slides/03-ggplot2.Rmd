...
.tiny[
```{r gglinha, fig.width = 8, fig.height = 4}
imdb %>% 
  group_by(ano) %>% 
...
.tiny[
```{r gglinhacolorida, fig.width = 8, fig.height = 3}
imdb %>% 
  filter(!is.na(cor)) %>% 
  group_by(ano, cor) %>% 
...
```{r ggdeniro, fig.width = 8, fig.height = 3}
imdb %>% 
...
```{r gglinhaponto, fig.width = 8, fig.height = 3}
imdb %>% 
  filter(ator_1 == "Robert De Niro") %>% 
  group_by(ano) %>% 
  summarise(nota_media = mean(nota_imdb, na.rm = TRUE)) %>% 
...
.tiny[
```{r gglinhalabel, fig.width = 8, fig.height = 3}
imdb %>% 
  filter(ator_1 == "Robert De Niro") %>% 
  group_by(ano) %>% 
  summarise(nota_media = mean(nota_imdb, na.rm = TRUE)) %>% 
...
.tiny[
```{r ggbarras, fig.width = 7, fig.height = 3.5}
imdb %>% 
  count(diretor) %>%
  top_n(10, n) %>%
  ggplot() +
...
.tiny[
```{r ggbarracolorida, fig.width = 7, fig.height = 3.5}
imdb %>% 
  count(diretor) %>%
...
.tiny[
```{r ggbarracoordflip, fig.width = 7, fig.height = 3.5}
imdb %>% 
  count(diretor) %>%
  filter(!is.na(diretor)) %>% 
  top_n(10, n) %>%
...
.tiny[
```{r ggbarraforcats, fig.width = 7, fig.height = 3.5}
imdb %>% 
  count(diretor) %>%
  filter(!is.na(diretor)) %>% 
  top_n(10, n) %>%
...
.tiny[
```{r ggbarralabel, fig.width = 7, fig.height = 3.5}
imdb %>% 
  count(diretor) %>%
  filter(!is.na(diretor)) %>% 
  top_n(10, n) %>%
...
```{r gghist, fig.width = 7, fig.height = 3.5}
imdb %>% 
...
.tiny[
```{r gghistbind, fig.width = 7, fig.height = 3.5}
imdb %>% 
  filter(diretor == "Steven Spielberg") %>%
  ggplot() +
  geom_histogram(
...
.tiny[
```{r ggboxplot, fig.width = 7, fig.height = 3.5}
imdb %>% 
  filter(!is.na(diretor)) %>%
  group_by(diretor) %>% 
  filter(n() >= 15) %>% 
...
.tiny[
```{r ggboxplotreorder, fig.width = 7, fig.height = 3.5}
imdb %>% 
  filter(!is.na(diretor)) %>%
  group_by(diretor) %>% 
  filter(n() >= 15) %>% 
...
.tiny[
```{r gglabs, fig.width = 7, fig.height = 3}
imdb %>%
  ggplot() +
...
.tiny[
```{r ggscale, fig.width = 7, fig.height = 3}
imdb %>% 
  group_by(ano) %>% 
  summarise(nota_media = mean(nota_imdb, na.rm = TRUE)) %>% 
  ggplot() +
...
.tiny[
```{r ggcoordcartesian, fig.width = 7, fig.height = 3}
imdb %>% 
  group_by(ano) %>% 
  summarise(nota_media = mean(nota_imdb, na.rm = TRUE)) %>% 
  ggplot() +
...
.tiny[
```{r ggfillmanual, fig.width = 7, fig.height = 3}
imdb %>% 
  count(diretor) %>%
  filter(!is.na(diretor)) %>% 
  top_n(5, n) %>%
...
.tiny[
```{r ggfillhex, fig.width = 7, fig.height = 3}
imdb %>% 
  count(diretor) %>%
  filter(!is.na(diretor)) %>% 
  top_n(5, n) %>%
...
.tiny[
```{r gglabelslegenda, fig.width = 7, fig.height = 3}
imdb %>% 
  filter(!is.na(cor)) %>% 
  group_by(ano, cor) %>% 
  summarise(num_filmes = n()) %>% 
...
.tiny[
```{r ggthemealterado, fig.width = 7, fig.height = 3}
imdb %>% 
  ggplot() +
