...
# 2. Reproduza os gráficos das matérias abaixo:
...
# 
# b) https://www.washingtonpost.com/graphics/2018/lifestyle/sinclair-broadcasting/
...
# 3. Teste os temas abaixo com os exemplos de aula:

# a) https://ewenme.github.io/ghibli/
# b) https://ryo-n7.github.io/tvthemes/

# 4. Escreva a label apropriada no eixo Y

library(ggplot2)
tibble::tibble(alpha = 1:10, alpha2 = log10(alpha^2)) %>% 
...
# 5. Crie um tema que você goste e nos mostre em sala
